...
NeededBytes:=Ascii85_DecoderSize(&Logo, 0xFFFFFFFF) ;  0xFFFFFFFF (即无符号长整型 -1) 表示是使用 '\0' 作为的结尾
...
Gui -Caption
Gui, Margin, 0, 0
Gui, Add, Text, x0 y0 w228 h133 +0xE hWndPic1 ; +0xE is SS_BITMAP（显示位图图像）  pic1是图片
